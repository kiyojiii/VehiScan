                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Applicant-Partner/Supplier List</li>
                                </ol>
                            </div>
...
@endif
                        ...
                        <div class="card">
                            <div class="card-body border-bottom">
                                <div class="d-flex align-items-center">
                                    <h5 class="mb-0 card-title flex-grow-1">Applicant-Partner/Supplier Lists</h5>
                                    <div class="flex-shrink-0">
                                        <a class="btn btn-success btn-sm my-2" onClick="add()" href="javascript:void(0)"><i class="bi bi-plus-circle"></i> Add Applicant-Partner/Supplier</a>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(function() {
            ...
            fetchAllPartnerApplicants();

            function fetchAllPartnerApplicants() {
                $.ajax({
                    url: '{{ route('fetchAllPartnerApplicant') }}',
                    method: 'get',
                    success: function(response) {
                        $("#show_all_partner_applicants").html(response);
                        $("table").DataTable({
