                                ...
                                <div class="pt-3">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-8">
                                            <div>
                                                Applicant: {{ $owners->id }}
                                                Vehicle: {{ $owners->vehicle ? $owners->vehicle->id : 'null' }}
                                                Driver: {{ $owners->vehicle && $owners->vehicle->driver ? $owners->vehicle->driver->id : 'null' }}
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <button id="{{ $owners->vehicle ? $owners->vehicle->id : 'null' }}" class="btn btn-primary mx-1 editIconVehicle" onClick="editVehicle('{{ $owners->vehicle ? $owners->vehicle->id : 'null' }}')">
                                                        <i class="bi-pencil-square"></i> Edit Vehicle
                                                    </button>
                                                ...
                                                <div class="mt-4">
                                                    <div class="text-muted font-size-14">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <h6>Official Receipt:</h6>
                                                                @if($owners->vehicle && $owners->vehicle->official_receipt_image)
                                                                <img src="{{ asset('storage/images/vehicles/documents/' . $owners->vehicle->official_receipt_image) }}" alt="official_receipt_image ID" class="img-thumbnail mx-auto d-block" style="width: 300px; height: 200px;">
                                                                @else
                                                                <p>No official receipt image found</p>
                                                                @endif
                                                            </div>
                                                            <div class="col">
                                                                <h6>Cert. of Registration:</h6>
                                                                @if($owners->vehicle && $owners->vehicle->certificate_of_registration_image)
                                                                <img src="{{ asset('storage/images/vehicles/documents/' . $owners->vehicle->certificate_of_registration_image) }}" alt="certificate_of_registration_image ID" class="img-thumbnail mx-auto d-block" style="width: 300px; height: 200px;">
                                                                @else
                                                                <p>No certificate of registration image found</p>
                                                                @endif
                                                            </div>
                                                            <div class="col">
                                                                <h6>Deed of Sale:</h6>
                                                                @if($owners->vehicle && $owners->vehicle->deed_of_sale_image)
                                                                <img src="{{ asset('storage/images/vehicles/documents/' . $owners->vehicle->deed_of_sale_image) }}" alt="deed_of_sale_image ID" class="img-thumbnail mx-auto d-block" style="width: 300px; height: 200px;">
                                                                @else
                                                                <p>No deed of sale image found</p>
                                                                @endif
                                                            </div>
                                                            <div class="col">
                                                                <h6>Authorization Letter:</h6>
                                                                @if($owners->vehicle && $owners->vehicle->authorization_letter_image)
                                                                <img src="{{ asset('storage/images/vehicles/documents/' . $owners->vehicle->authorization_letter_image) }}" alt="authorization_letter_image ID" class="img-thumbnail mx-auto d-block" style="width: 300px; height: 200px;">
                                                                @else
                                                                <p>No authorization letter image found</p>
                                                                @endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <img src="{{ asset('storage/images/vehicles/' . $owners->vehicle->front_photo) }}" alt="front_photo ID" class="img-thumbnail mx-auto d-block" style="width: 300px; height: 200px;">
                                                                @else
                                                                <p>No front photo found</p>
                                                                @endif
                                                            </div>
                                                            <div class="col">
                                                                <h6>Side Photo:</h6>
