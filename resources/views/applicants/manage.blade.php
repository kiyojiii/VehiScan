                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <!-- Edit Modal -->
                            <div class="modal fade" id="editApplicantModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Applicant</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>

                                        <div class="modal-body">
                                            <form action="javascript:void(0)" id="edit_applicant_form" name="edit_applicant_form" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div id="basic-example">
                                                    <!-- Applicant Details -->
                                                    <section id="applicantDetailsSection">
                                                    ...
                                                    <section id="driverDetailsSection" style="display: none;">
                                                        ...
                                                        <div class="modal-footer" id="modalFooterButtons">
                                                            <button type="button" class="btn btn-secondary" onclick="prevStep()">Back</button>
                                                            <button type="submit" id="edit_applicant_btn" class="btn btn-success" id="btn-save">Add Applicant</button>
                                                        </div>
                                                    </section>
