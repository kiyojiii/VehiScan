        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="javascript:void(0)" id="edit_driver_form" name="edit_driver_form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input name="dlicense_photo" id="dlicense_photo">
                    <input name="adlicense_photo" id="adlicense_photo">
                    <!-- Driver's Info -->
                    ...
                    <div class="row">
                        ...
                        <img src="{{ asset('storage/images/drivers/' . $owner->vehicle->driver->driver_license_image) }}" alt="driver_license_image" class="img-thumbnail mx-auto d-block" style="width: 300px; height: 200px;">
                        @else
                    ...
                    <div class="row">
                        ...
                        @if($owner->vehicle && $owner->vehicle->driver)
                        <img src="{{ asset('storage/images/drivers/' . $owner->vehicle->driver->authorized_driver_license_image) }}" alt="authorized_driver_license_image" class="img-thumbnail mx-auto d-block" style="width: 300px; height: 200px;">
                        @else
                        <!-- Display a placeholder image or message -->
                        <p>No driver associated</p>
                        @endif
