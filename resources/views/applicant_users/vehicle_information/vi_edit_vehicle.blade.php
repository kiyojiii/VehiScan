            ...
            <div class="modal-body">
                <form action="javascript:void(0)" id="edit_vehicle_form" name="edit_vehicle_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="vehicle_id" name="vehicle_id" value="{{ $vehicles->id ?? 'Null' }}" readonly>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" name="registration_status" id="registration_status" placeholder="Registration Status" value="Pending" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
