...
<head>
    ...
    <title>MVIS | Vehicle - Details</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-content">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="vstack gap-3">
                                    ...
                                    <li>
                                        ...
                                        <span>{{ $vehicles->owner_name ?? 'N/A' }}</span>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <span>{{ $vehicles->vehicle_category ?? 'N/A' }}</span>
                                    </li>
                                    <li>
            ...
            @include('applicant_users.vehicle_information.vehicle_information_js')
            @include('applicants.show_modals')
            @include('applicant_users.vehicle_information.vi_edit_vehicle')
            @include('applicant_users.vehicle_information.vi_edit_driver')
</body>
