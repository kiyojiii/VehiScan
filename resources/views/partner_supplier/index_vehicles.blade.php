...
<head>
    ...
    <title>VehiScan | Vehicle - Partner/Supplier </title>
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Partner/Supplier Vehicles</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body border-bottom">
                                <div class="d-flex align-items-center">
                                    <h5 class="mb-0 card-title flex-grow-1">Partner/Supplier Vehicle Count: {{ $totalpartnervehicles }}</h5>
                            ...
                            <div class="card-body" id="show_partner_vehicles">
                                <h1 class="text-center text-secondary my-5"> Loading... </h1>
                            </div>

                            @include('partner_supplier.vehicle_modals')
                ...
                @include('partner_supplier.vehicle_js')
