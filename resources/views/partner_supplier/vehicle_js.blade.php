...
<script>
        $(function() {
            ...
            function fetchAllPartnerVehicles() {
                $.ajax({
                    url: '{{ route('fetchAllPartnerVehicle') }}',
                    method: 'get',
                    success: function(response) {
                        $("#show_partner_vehicles").html(response);
                    ...
                    error: function(xhr, status, error) {
                        ...
                        $("#show_partner_vehicles").html("<p>Error fetching data. Please try again later.</p>");
                    }
                });
            }
